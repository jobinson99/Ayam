...
# fill "en"-locale...
ms_init en
ms_set en ayprefse_GuiScale "Zoom factor for the GUI as set by command line\
argument \"-guiscale\""
...
ms_set en ayprefse_ScopeManagement "How to decide wether objects or points\
should be transformed?\
\nImplicit: Selected points will be transformed, else objects;\
\nExplicit: <o> (objects) / <p> (points) will be transformed."
...
ms_set en ayprefse_CreateAt "Where to create objects?"
ms_set en ayprefse_CreateIn "Use orientation of new objects from?"
...
# Drawing
ms_set en ayprefse_UseGUIScale\
"Adapt line widths and point sizes to GUI scale?"
...
ms_set de ayprefse_GuiScale "Zoomfaktor für die GUI, gesetzt durch\
Kommandozeilenargument \"-guiscale\"."
...
# Modeling
ms_set de ayprefse_ScopeManagement "Wie soll entschieden werden, ob Objekte\
oder Punkte transformiert werden?\
\nImplicit: Selektierte Punkte werden transformiert, sonst Objekte;\
\nExplicit: <o> (Objekte) / <p> (Punkte) werden transformiert."
...
ms_set de ayprefse_CreateAt "Wo sollen neue Objekte erzeugt\
werden?"
ms_set de ayprefse_CreateIn "In welcher Ebene sollen neue Objekte erzeugt\
werden?"
...
# Drawing
ms_set de ayprefse_UseGUIScale\
"Soll die Darstellung an den GUI-Zoomfaktor angepasst werden?"
...
ms_set de ayprefse_DisplayDriver "Display-Treiber für Vorschau-Renderer."
ms_set de ayprefse_QDisplayDriver "Display-Treiber für den schnellen\
 Vorschau-Renderer."
...
setzen?"
ms_set de ayprefse_SetActionMenu "Elemente des Aktionsmenüs konfigurieren!"
...
#ms_set fr ayprefse_GuiScale "Zoom-factor for the GUI as set by command line argument \"-guiscale\""
...
#ms_set fr ayprefse_ScopeManagement "How to decide wether objects or points\
#should be transformed?"
...
#marks (one for each view)?"
#ms_set fr ayprefse_CreateAt "Where to create objects?"
#ms_set fr ayprefse_CreateIn "Orientation of new objects?"
...
# Drawing
#ms_set fr ayprefse_UseGUIScale\
#"Adapt line widths and point sizes to GUI scale?"
...
RIB?"
ms_set fr ayprefse_RenderMode "Mode de rendu d'aperçu à l'écran?"
