...
# prog.tcl - this file implements a progress bar
# code taken from Donald K. Fellows (dkf) Megawidget and Dialog Stuff:
# http://www.cs.man.ac.uk/~fellowsd/tcl/mwidx.html
# (because Jeffrey Hobbs progressbar.tcl is unnecessary big/complex)
...
option add *Progress.doneBackground   blue4 widgetDefault
