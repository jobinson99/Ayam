...
proc prefs_open {} {
    ...
    addText $fw e1 "GUI:"
    addInfoB $fw ay GuiScale [ms ayprefse_GuiScale]
    set l $ay(locales)
    ...
    addMenuB $fw ayprefse ScopeManagement [ms ayprefse_ScopeManagement]\
     {"Explicit" "Implicit"}
    ...
    addMenuB $fw ayprefse CreateAt [ms ayprefse_CreateAt]\
	{"World Origin" "Mark" "View Aim Point"}
    addMenuB $fw ayprefse CreateIn [ms ayprefse_CreateIn]\
	{"World CS" "View CS" "Camera CS"}
    ...
    addCheckB $fw ayprefse UseGUIScale [ms ayprefse_UseGUIScale]
