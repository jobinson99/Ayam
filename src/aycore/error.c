 ...
 *
 * \param[in] fname  location of error
 * \param[in] pname  parameter name
 * \param[in] lb  lower bound of range
 * \param[in] ub  upper bound of range
 *
 ...
 *
 * \param[in] ecode  error code (AY_E*)
 * \param[in] fname  location of error
 * \param[in] o  object (must be linked to the scene)
 *
 * \returns AY_OK on success, error code otherwise.
 */
int
