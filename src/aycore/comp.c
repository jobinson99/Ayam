...
int ay_comp_apatch(ay_object *o1, ay_object *o2);
 ...
 */
int
ay_comp_apatch(ay_object *o1, ay_object *o2)
{
 ay_apatch_object *a1, *a2;

  a1 = (ay_apatch_object *)o1->refine;
  a2 = (ay_apatch_object *)o2->refine;

  if((a1->mode != a2->mode) ||
     (a1->width != a2->width) ||
     (a1->height != a2->height) ||
     (a1->awidth != a2->awidth) ||
     (a1->aheight != a2->aheight) ||
     (a1->close_u != a2->close_u) ||
     (a1->close_v != a2->close_v) ||
     (a1->order_u != a2->order_u) ||
     (a1->order_v != a2->order_v) ||
     (a1->ktype_u != a2->ktype_u) ||
     (a1->ktype_v != a2->ktype_v))
    return AY_FALSE;

  if(memcmp(a1->controlv, a2->controlv, 3*a1->width*a1->height*sizeof(double)))
    return AY_FALSE;
...
ay_comp_init()
{
 ...
 char fname[] = "comp_init";
  ...
  ay_status += ay_comp_register(ay_comp_apatch, AY_IDAPATCH);
