		     ...
		     int argc, char *argv[])
{
 ...
 double quat[4], drot;
 int i, pasteProp = 0, notify_parent = AY_FALSE;
 char *quats[4] = {"Quat0", "Quat1", "Quat2", "Quat3"};
  ...
  if((to = Tcl_GetVar2Ex(interp, arr, "Translate_X",
			 TCL_LEAVE_ERR_MSG | TCL_GLOBAL_ONLY)))
    {
      /*
  ...
  if((to = Tcl_GetVar2Ex(interp, arr, "Translate_Y",
			 TCL_LEAVE_ERR_MSG | TCL_GLOBAL_ONLY)))
    {
      /*
  ...
  if((to = Tcl_GetVar2Ex(interp, arr, "Translate_Z",
			 TCL_LEAVE_ERR_MSG | TCL_GLOBAL_ONLY)))
    {
      /*
  ...
  for(i = 0; i < 4; i++)
    {
      if((to = Tcl_GetVar2Ex(interp, arr, quats[i],
			     TCL_LEAVE_ERR_MSG | TCL_GLOBAL_ONLY)))
	{
	  Tcl_GetDoubleFromObj(interp, to, &dtemp);
	  if(dtemp != o->quat[i])
  ...
  if((to = Tcl_GetVar2Ex(interp, arr, "Rotate_X",
			 TCL_LEAVE_ERR_MSG | TCL_GLOBAL_ONLY)))
    {
  ...
  if((to = Tcl_GetVar2Ex(interp, arr, "Rotate_Y",
			 TCL_LEAVE_ERR_MSG | TCL_GLOBAL_ONLY)))
    {
  ...
  if((to = Tcl_GetVar2Ex(interp, arr, "Rotate_Z",
			 TCL_LEAVE_ERR_MSG | TCL_GLOBAL_ONLY)))
    {
  ...
  if((to = Tcl_GetVar2Ex(interp, arr, "Scale_X",
			 TCL_LEAVE_ERR_MSG | TCL_GLOBAL_ONLY)))
    {
      /*
  ...
  if((to = Tcl_GetVar2Ex(interp, arr, "Scale_Y",
			 TCL_LEAVE_ERR_MSG | TCL_GLOBAL_ONLY)))
    {
      /*
  ...
  if((to = Tcl_GetVar2Ex(interp, arr, "Scale_Z",
			 TCL_LEAVE_ERR_MSG | TCL_GLOBAL_ONLY)))
    {
      /*
		    ...
		    int argc, char *argv[])
{
 ...
 int stringlen;
  ...
  if((to = Tcl_GetVar2Ex(interp, arr, "Objectname",
			 TCL_LEAVE_ERR_MSG | TCL_GLOBAL_ONLY)))
    {
  ...
  if((to = Tcl_GetVar2Ex(interp, arr, "Hide",
			 TCL_LEAVE_ERR_MSG | TCL_GLOBAL_ONLY)))
    Tcl_GetIntFromObj(interp, to, &(o->hide));

  if((to = Tcl_GetVar2Ex(interp, arr, "HideChildren",
			 TCL_LEAVE_ERR_MSG | TCL_GLOBAL_ONLY)))
		   ...
		   int argc, char *argv[])
{
 ...
 ay_mat_object *material = NULL;
  ...
  if((to = Tcl_GetVar2Ex(interp, arr, "Materialname",
			 TCL_LEAVE_ERR_MSG | TCL_GLOBAL_ONLY)))
    {
      string = Tcl_GetStringFromObj(to, &stringlen);
      if(!string)
      ...
      if(o->mat)
	{
	  ...
	  if(m)
	    ...
	    ay_error(AY_ERROR, argv[0],
		     "could not decrease material refcount!");
	}
