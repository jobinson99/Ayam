		 ...
		 int argc, char *argv[])
{
 char *arr = "ayprefs";
  ...
  Tcl_SetVar2Ex(interp, arr, "UseGUIScale",
		Tcl_NewIntObj(ay_prefs.useguiscale),
		TCL_LEAVE_ERR_MSG | TCL_GLOBAL_ONLY);
  ...
  Tcl_SetVar2Ex(interp, arr, "CreateAt",
		Tcl_NewIntObj(ay_prefs.createat),
		TCL_LEAVE_ERR_MSG | TCL_GLOBAL_ONLY);

  Tcl_SetVar2Ex(interp, arr, "CreateIn",
		Tcl_NewIntObj(ay_prefs.createin),
		TCL_LEAVE_ERR_MSG | TCL_GLOBAL_ONLY);
  ...
  Tcl_SetVar2Ex(interp, arr, "SelBndFactor",
		Tcl_NewDoubleObj(ay_prefs.selbndfactor),
		TCL_LEAVE_ERR_MSG | TCL_GLOBAL_ONLY);
  ...
  Tcl_SetVar2Ex(interp, arr, "ScopeManagement",
		Tcl_NewIntObj(ay_prefs.scopemanagement),
		TCL_LEAVE_ERR_MSG | TCL_GLOBAL_ONLY);
		 ...
		 int argc, char *argv[])
{
 ...
 if(argc > 1)
  ...
  do
  {
	...
	if(setall || arglen == 12)
	  {
	    to = Tcl_GetVar2Ex(interp, arr, "UseGUIScale",
			       TCL_LEAVE_ERR_MSG | TCL_GLOBAL_ONLY);
	    Tcl_GetIntFromObj(interp, to, &(ay_prefs.useguiscale));
	  }
      } /* A... */
	...
	to = Tcl_GetVar2Ex(interp, arr, "CreateAt",
			   TCL_LEAVE_ERR_MSG | TCL_GLOBAL_ONLY);
	Tcl_GetIntFromObj(interp, to, &(ay_prefs.createat));

	to = Tcl_GetVar2Ex(interp, arr, "CreateIn",
			   TCL_LEAVE_ERR_MSG | TCL_GLOBAL_ONLY);
	Tcl_GetIntFromObj(interp, to, &(ay_prefs.createin));
	...
	to = Tcl_GetVar2Ex(interp, "ay", "GuiScale",
			   TCL_LEAVE_ERR_MSG | TCL_GLOBAL_ONLY);
	Tcl_GetDoubleFromObj(interp, to, &(ay_prefs.guiscale));
    ...
    if(setall || (argv[i][0] == 'S'))
      {
	to = Tcl_GetVar2Ex(interp, arr, "ScopeManagement",
			   TCL_LEAVE_ERR_MSG | TCL_GLOBAL_ONLY);
	Tcl_GetIntFromObj(interp, to, &(ay_prefs.scopemanagement));

	to = Tcl_GetVar2Ex(interp, arr, "SelLineWidth",
			   TCL_LEAVE_ERR_MSG | TCL_GLOBAL_ONLY);
	Tcl_GetDoubleFromObj(interp, to, &(ay_prefs.sellinewidth));

	to = Tcl_GetVar2Ex(interp, arr, "SelBndFactor",
			   TCL_LEAVE_ERR_MSG | TCL_GLOBAL_ONLY);
	Tcl_GetDoubleFromObj(interp, to, &(ay_prefs.selbndfactor));
