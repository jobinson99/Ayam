...
char *pre;
 ...
 char buf[5], fname[] = "read_header";
...
#ifdef AYACCEPTPRE
  if(strstr(AY_VERSIONSTR, "pre"))
    {
      if((pre = strstr(version, "pre")))
	{
	  *pre = '\0';
	}
    }
  ...
  if(!strcmp(version, "1.31"))
    {
      ay_read_version = 17;
      version_unknown = AY_FALSE;
    }
  else
  if(!strcmp(version, "1.30"))
    {
      ay_read_version = 17;
      version_unknown = AY_FALSE;
    }
  else
  if(!strcmp(version, "1.29"))
    {
      ay_read_version = 16;
      version_unknown = AY_FALSE;
    }
  else
  if(!strcmp(version, "1.28"))
    {
      ay_read_version = 16;
      version_unknown = AY_FALSE;
    }
  else
  if(!strcmp(version, "1.27"))
    {
      ay_read_version = 16;
      version_unknown = AY_FALSE;
    }
  else
  if(!strcmp(version, "1.26"))
    {
      ay_read_version = 16;
      version_unknown = AY_FALSE;
    }
  else
  if(!strcmp(version, "1.25"))
    {
      ay_read_version = 16;
      version_unknown = AY_FALSE;
    }
