...
/** language id */
static unsigned int luainterp_langid;
...
static const struct luaL_Reg luainterplib [] = {
      ...
      {"getNormal", luainterp_wraptclcmd},
      {"setNormal", luainterp_wraptclcmd},
      {"getTangent", luainterp_wraptclcmd},
      ...
      {"coarsenC", luainterp_wraptclcmd},
      {"getPlaneNormal", luainterp_wraptclcmd},
      ...
      {"toYZC", luainterp_wraptclcmd},
      {"toXZC", luainterp_wraptclcmd},
      {"isCompNC", luainterp_wraptclcmd},
      {"isCompNP", luainterp_wraptclcmd},
      {"makeCompNC", luainterp_wraptclcmd},
      {"makeCompNP", luainterp_wraptclcmd},
      ...
      {"fairNC", luainterp_wraptclcmd},
      {"curvatNC", luainterp_wraptclcmd},
      {"torsionNC", luainterp_wraptclcmd},
      ...
      {"curvatNP", luainterp_wraptclcmd},
      {"fairNP", luainterp_wraptclcmd},
      {"approxNP", luainterp_wraptclcmd},
