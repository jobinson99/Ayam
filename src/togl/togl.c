...
/*
 * Currently support X11 and WIN32/WIN64
 */
#ifndef WIN32
#ifndef WIN64
#define X11
...
#include <winnt.h>
/* The rest of the file is happy with WIN32 */
#define WIN32
#endif /*WIN64*/
...
{
   char *name;
   /* XXXX changed main to mainw to eliminate warning */
   ...
   /* Create the window. */
   name = argv[1];
   tkwin = Tk_CreateWindowFromPath(interp, mainw, name, (char *) NULL);
   if (tkwin == NULL) {
      return TCL_ERROR;
   }
