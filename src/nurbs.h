 ...
 */
int ay_act_leastSquares(double *Q, int m, int n, int p, int kt,
			double **U, double **P);

/** Do a least squares approximation for a closed curve.
 */
int ay_act_leastSquaresClosed(double *Q, int m, int n, int p, int kt,
			      double **U, double **P);
 ...
 */
int ay_apt_getpntfromindex(ay_apatch_object *patch, int indexu, int indexv,
			   double **p);
 ...
 */
int ay_apt_approximateuv(double *cv, int width, int height,
 ...
 */
int ay_apt_approximatevu(double *cv, int width, int height,
			 int awidth, int aheight,
			 int uorder, int vorder,
			 int uknottype, int vknottype,
			 int closeu, int closev,
 ...
 */
int ay_apt_approximateu(double *cv, int width, int height,
			int awidth,
			int uorder, int vorder,
			int uknottype, int vknottype,
			int closeu, int closev,
 ...
 */
int ay_apt_approximatev(double *cv, int width, int height,
			int aheight,
			int uorder, int vorder,
			int uknottype, int vknottype,
			int closeu, int closev,
 ...
 */
int ay_apt_approxtcmd(ClientData clientData, Tcl_Interp *interp,
		      int argc, char *argv[]);
 ...
 */
int ay_knots_evalparam(char **fpname, double u, int relative, int length,
		       int order, double *knotv, double *v);
 ...
 */
int ay_nct_getorientation3d(ay_nurbcurve_object *curve, int stride,
...
/** Calculate torsion at parameter value \a u.
 */
 ...
 */
int ay_nct_intersectsets(int ncu, ay_object *cu, int ncv, ay_object *cv,
 ...
 */
int ay_nct_shiftctcmd(ClientData clientData, Tcl_Interp *interp,
		      int argc, char *argv[]);
 ...
 */
int ay_npt_dualskin(ay_object *cu, ay_object *cv, ay_object *tc,
		    int uorder, int vorder,
 ...
 */
int ay_npt_extracttrim(ay_object *o, int tnum, double param, int apply_trafo,
 ...
 */
int ay_npt_fair(ay_nurbpatch_object *np, ay_point *selp, double tol,
		int mode, int worst);

/** Tcl command to improve the shape of a NURBS surface.
 */
int ay_npt_fairnptcmd(ClientData clientData, Tcl_Interp *interp,
		      int argc, char *argv[]);
 ...
 */
int ay_npt_selectbound(ay_object *o, unsigned int pid, unsigned int bid,
		       int format);
 ...
 */
int ay_npt_tgordon(ay_object **curves, int uorder, int vorder,
		   ay_nurbpatch_object **gordon);
 ...
 */
int ay_tess_quadrangulate(ay_object *o, ay_nurbpatch_object *np, double *uv,
 ...
 */
int ay_tess_ncurve(ay_nurbcurve_object *ncurve, double tmode, double tparam,
 ...
 */
int ay_rtess_tessnp(ay_nurbpatch_object *np, int degen, double tolerance,
		    ay_object **result);
