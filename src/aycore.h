 ...
 */
int ay_clipb_cleartcmd(ClientData clientData, Tcl_Interp *interp,
		       int argc, char *argv[]);
...
/** place/orient object o according to user preferences
 */
void ay_object_place(ay_object *o);

/** initially place/orient an object
 */
int ay_object_placetcmd(ClientData clientData, Tcl_Interp *interp,
			int argc, char *argv[]);
 ...
 */
int ay_pomesht_quadrangulatetcmd(ClientData clientData, Tcl_Interp *interp,
				 int argc, char *argv[]);
/* prefs.c */
 ...
 */
int ay_tcmd_gettangenttcmd(ClientData clientData, Tcl_Interp *interp,
			   int argc, char *argv[]);
 ...
 */
int ay_tcmd_setnormaltcmd(ClientData clientData, Tcl_Interp *interp,
			  int argc, char *argv[]);
