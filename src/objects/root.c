...
ay_root_setpropcb(Tcl_Interp *interp, int argc, char *argv[], ay_object *o)
{
 ...
 const char *stemp;
  ...
  if((to = Tcl_GetVar2Ex(interp, arr, "Variance",
  ...
  if((to = Tcl_GetVar2Ex(interp, arr, "Samples_X",
			 TCL_LEAVE_ERR_MSG | TCL_GLOBAL_ONLY)))
    Tcl_GetDoubleFromObj(interp, to, &(riopt->Samples_X));

  if((to = Tcl_GetVar2Ex(interp, arr, "Samples_Y",
			 TCL_LEAVE_ERR_MSG | TCL_GLOBAL_ONLY)))
    Tcl_GetDoubleFromObj(interp, to, &(riopt->Samples_Y));

  if((to = Tcl_GetVar2Ex(interp, arr, "FilterFunc",
			 TCL_LEAVE_ERR_MSG | TCL_GLOBAL_ONLY)))
    {
  ...
  if((to = Tcl_GetVar2Ex(interp, arr, "FilterWidth",
			 TCL_LEAVE_ERR_MSG | TCL_GLOBAL_ONLY)))
    Tcl_GetDoubleFromObj(interp, to, &(riopt->FilterWidth));

  if((to = Tcl_GetVar2Ex(interp, arr, "FilterHeight",
			 TCL_LEAVE_ERR_MSG | TCL_GLOBAL_ONLY)))
    Tcl_GetDoubleFromObj(interp, to, &(riopt->FilterHeight));

  if((to = Tcl_GetVar2Ex(interp, arr, "ExpGain",
			 TCL_LEAVE_ERR_MSG | TCL_GLOBAL_ONLY)))
    Tcl_GetDoubleFromObj(interp, to, &(riopt->ExpGain));

  if((to = Tcl_GetVar2Ex(interp, arr, "ExpGamma",
			 TCL_LEAVE_ERR_MSG | TCL_GLOBAL_ONLY)))
    Tcl_GetDoubleFromObj(interp, to, &(riopt->ExpGamma));

  if((to = Tcl_GetVar2Ex(interp, arr, "RGBA_ONE",
			 TCL_LEAVE_ERR_MSG | TCL_GLOBAL_ONLY)))
    {
      Tcl_GetIntFromObj(interp, to, &itemp);
  ...
  if((to = Tcl_GetVar2Ex(interp, arr, "RGBA_MIN",
			 TCL_LEAVE_ERR_MSG | TCL_GLOBAL_ONLY)))
    {
      Tcl_GetIntFromObj(interp, to, &itemp);
  ...
  if((to = Tcl_GetVar2Ex(interp, arr, "RGBA_MAX",
			 TCL_LEAVE_ERR_MSG | TCL_GLOBAL_ONLY)))
    {
      Tcl_GetIntFromObj(interp, to, &itemp);
  ...
  if((to = Tcl_GetVar2Ex(interp, arr, "RGBA_Dither",
			 TCL_LEAVE_ERR_MSG | TCL_GLOBAL_ONLY)))
    {
  ...
  if((to = Tcl_GetVar2Ex(interp, arr, "MinSamples",
			 TCL_LEAVE_ERR_MSG | TCL_GLOBAL_ONLY)))
    {
      Tcl_GetIntFromObj(interp, to, &itemp);
  ...
  if((to = Tcl_GetVar2Ex(interp, arr, "MaxSamples",
			 TCL_LEAVE_ERR_MSG | TCL_GLOBAL_ONLY)))
    {
      Tcl_GetIntFromObj(interp, to, &itemp);
  ...
  if((to = Tcl_GetVar2Ex(interp, arr, "MaxRayLevel",
			 TCL_LEAVE_ERR_MSG | TCL_GLOBAL_ONLY)))
    {
      Tcl_GetIntFromObj(interp, to, &itemp);
  ...
  if((to = Tcl_GetVar2Ex(interp, arr, "ShadowBias",
			 TCL_LEAVE_ERR_MSG | TCL_GLOBAL_ONLY)))
    {
      Tcl_GetDoubleFromObj(interp, to, &dtemp);
  ...
  if((to = Tcl_GetVar2Ex(interp, arr, "PRManSpec",
			 TCL_LEAVE_ERR_MSG | TCL_GLOBAL_ONLY)))
    {
      Tcl_GetIntFromObj(interp, to, &itemp);
  ...
  if((to = Tcl_GetVar2Ex(interp, arr, "RadSteps",
			 TCL_LEAVE_ERR_MSG | TCL_GLOBAL_ONLY)))
    {
      Tcl_GetIntFromObj(interp, to, &itemp);
  ...
  if((to = Tcl_GetVar2Ex(interp, arr, "PatchSamples",
			 TCL_LEAVE_ERR_MSG | TCL_GLOBAL_ONLY)))
    {
      Tcl_GetIntFromObj(interp, to, &itemp);
  ...
  if((stemp = Tcl_GetVar2(interp, arr, "Textures",
			  TCL_LEAVE_ERR_MSG | TCL_GLOBAL_ONLY)))
    {
      if(riopt->textures)
	{
  ...
  if((stemp = Tcl_GetVar2(interp, arr, "Shaders",
			  TCL_LEAVE_ERR_MSG | TCL_GLOBAL_ONLY)))
    {
      if(riopt->shaders)
	{
  ...
  if((stemp = Tcl_GetVar2(interp, arr, "Archives",
			  TCL_LEAVE_ERR_MSG | TCL_GLOBAL_ONLY)))
    {
      if(riopt->archives)
	{
  ...
  if((stemp = Tcl_GetVar2(interp, arr, "Procedurals",
			  TCL_LEAVE_ERR_MSG | TCL_GLOBAL_ONLY)))
    {
      if(riopt->procedurals)
	{
  ...
  if((to = Tcl_GetVar2Ex(interp, arr, "TextureMem",
			 TCL_LEAVE_ERR_MSG | TCL_GLOBAL_ONLY)))
    {
      Tcl_GetIntFromObj(interp, to, &itemp);
  ...
  if((to = Tcl_GetVar2Ex(interp, arr, "GeomMem",
			 TCL_LEAVE_ERR_MSG | TCL_GLOBAL_ONLY)))
    {
      Tcl_GetIntFromObj(interp, to, &itemp);
      riopt->geommem = itemp;
  ...
  if((to = Tcl_GetVar2Ex(interp, arr, "StdDisplay",
			 TCL_LEAVE_ERR_MSG | TCL_GLOBAL_ONLY)))
    {
      Tcl_GetIntFromObj(interp, to, &itemp);
